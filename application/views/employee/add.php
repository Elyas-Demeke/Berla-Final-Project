        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                  ...
                  <form role="form" method="post" enctype="multipart/form-data" accept-charset="utf-8" action="<?php echo base_url('Employees/add')?>">
                    <div class="row">
    ...
    <div class="form-group">
       ...
       <div class="form-check form-check-inline">
           <input class="form-check-input" type="radio" name="status[]" id="employee_inactive" value="2">
