            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo base_url('Dashboard')?>"><i class="fa fa-calendar-check-o"></i> <span>Doctor Schedule</span></a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('Dashboard')?>"><i class="fa fa-hospital-o"></i> <span>Departments</span></a>
                        </li>
						<li class="submenu">
							<a href="#"><i class="fa fa-user"></i> <span> Employees </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="<?php echo base_url('Dashboard')?>">Employees List</a></li>
								<li><a href="<?php echo base_url('Dashboard')?>">Leaves</a></li>
								<li><a href="<?php echo base_url('Dashboard')?>">Holidays</a></li>
								<li><a href="<?php echo base_url('Dashboard')?>">Attendance</a></li>
							</ul>
						</li>
						<li class="submenu">
							<a href="#"><i class="fa fa-money"></i> <span> Accounts </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="<?php echo base_url('Dashboard')?>">Invoices</a></li>
								<li><a href="<?php echo base_url('Dashboard')?>">Payments</a></li>
								<li><a href="<?php echo base_url('Dashboard')?>">Expenses</a></li>
								<li><a href="<?php echo base_url('Dashboard')?>">Taxes</a></li>
