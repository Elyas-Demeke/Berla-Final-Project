        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                  ...
                  <form role="form" method="post" enctype="multipart/form-data" accept-charset="utf-8" action="<?php echo base_url('Patients/add')?>">
                    <div class="row">
                        <div class="col-sm-6">
                   ...
                   <div class="row">
                      <div class="col-sm-6">
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="home_number" required value="<?php echo set_value('Home_number');?>">
                        </div>
                    </div>
   ...
   <div class="m-t-20 text-center col-sm-12">
    <button type="submit" class="btn btn-primary submit-btn">Admit Patient</button>
</div>
</form>
</div>
</div>
